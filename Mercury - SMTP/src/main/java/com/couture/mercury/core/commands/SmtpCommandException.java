 ...
 */
public class SmtpCommandException extends Exception{
     ...
     */
    public SmtpCommandException(String message, int responseCode){
        super(message);
     ...
     * @param responseCode Corresponding SMTP response code.
     */
    public SmtpCommandException(String message, Throwable cause, int responseCode){
        super(message, cause);
        m_responseCode = responseCode;
    }
