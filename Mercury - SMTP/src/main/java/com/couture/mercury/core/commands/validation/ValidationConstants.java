...
public class ValidationConstants {
    ...
    public static final String HELO_PATTERN = "^HELO\\s+" + DOMAIN_PART_PATTERN + "$";
    public static final String EHLO_PATTERN = "^EHLO\\s+" + DOMAIN_PART_PATTERN + "$";
    public static final String MAIL_PATTERN = "^MAIL\\s+FROM:\\s*<([^>]*)>$";
    public static final String RCPT_PATTERN = "^RCPT\\s+TO:\\s*<([^>]*)>$";
    public static final String DATA_PATTERN = "^DATA$";
    public static final String QUIT_PATTERN = "^QUIT$";
    public static final String RSET_PATTERN = "^RSET$";
    public static final String NOOP_PATTERN = "^NOOP(\\s.*)?$";
    public static final String VRFY_PATTERN = "^VRFY\\s+(.+)$";
